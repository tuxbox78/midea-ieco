...
| 27.07.2026 | **t3n** — Jörn Brien | [Wie ein Open-Source-Tool den Stromverbrauch senken soll](https://t3n.de/news/strom-sparen-ieco-midea-portasplit-1754965/) — ausführliches Porträt dieses Projekts: versteckter iECO-Modus, bis zu 60 % Ersparnis, vollständig lokale Steuerung nach dem einmaligen Token-Abruf |
| 27.07.2026 | **mobiflip** — René Hesse | [Open-Source-Tool sichert lokale Steuerung](https://www.mobiflip.de/midea-portasplit-open-source-tool-sichert-lokale-steuerung/) — Folgebeitrag zu den Token-API-Befunden dieses Projekts und der rein lokalen Steuerung |
| 30.07.2026 | **allround-pc.com** — Arian Krasniqi | [Mit diesem Open-Source-Tool den Stromverbrauch senken](https://www.allround-pc.com/news/midea-portasplit-kuehlt-durch-den-sommer-mit-diesem-open-source-tool-senkt-ihr-den-stromverbrauch) — stellt das Tool als Abhilfe vor: versteckter iECO-Modus, bis zu 60 % Ersparnis, rein lokale Steuerung |

Zur Transparenz: Messdaten, API-Protokoll und Screenshots habe ich `techboys.de` zur Verfügung gestellt und werde dort als Quelle genannt. Zwei Beiträge gehen auf eine Presse-E-Mail von mir mit denselben API-Befunden zurück — **SmarthomeAssistent** und der **mobiflip**-Folgeartikel (der ausdrücklich schreibt, dass ich die Redaktion auf das Tool hingewiesen habe); der SmarthomeAssistent-Beitrag weist offen darauf hin, dass der Redaktion keine unabhängige Prüfung des Tools vorlag. **t3n** und **allround-pc.com** haben über das Projekt ohne jede Ansprache meinerseits berichtet. Die Artikel selbst sind redaktionell unabhängig entstanden und wurden von den Autoren eigenständig nachgerechnet — es floss kein Geld, in keine Richtung, und ich hatte keinen Einfluss auf die Formulierungen. Die zugrunde liegenden Rohdaten sind unter [Hintergrund: ECO vs. iECO](#hintergrund-eco-vs-ieco) beschrieben; die Grenzen der Messung stehen dort genauso offen wie in den Artikeln.
